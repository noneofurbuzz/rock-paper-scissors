...
export default function Settings(){
    ...
    return(
        ...
        <button className="button-reflect border-white border-[1px] text-white tracking-[0.2em] rounded-lg xxs:w-72 w-full py-2 bg-[#141539] hover:ease-in-out hover:scale-[0.955] hover:brightness-125 duration-300 active:ease-in-out active:scale-[0.955] active:brightness-125">NEW GAME</button>
        </div>
